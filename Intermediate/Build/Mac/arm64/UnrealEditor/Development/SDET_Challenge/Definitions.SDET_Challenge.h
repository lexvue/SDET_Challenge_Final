...
#define UE_PROJECT_NAME SDET_Challenge
#define UE_TARGET_NAME SDET_ChallengeEditor
#define UE_MODULE_NAME "SDET_Challenge"
...
#define SDET_CHALLENGE_API DLLEXPORT
